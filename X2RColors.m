...
+(UIColor *)redColor{
    return colorRed!=nil ? colorRed : [UIColor colorWithRed:0.792 green:0.188 blue:0.235 alpha:1];
}

+(UIColor *)lightBlueColor{
    return colorRed!=nil ? colorRed : [UIColor colorWithRed:0.2 green:0.71 blue:0.898 alpha:1];
}

+(UIColor *)purpleColor{
    return colorRed!=nil ? colorRed : [UIColor colorWithRed:0.667 green:0.4 blue:0.8 alpha:1];
}

+(UIColor *)greenColor{
    return colorRed!=nil ? colorRed : [UIColor colorWithRed:0.6 green:0.8 blue:0.1 alpha:1];
}
